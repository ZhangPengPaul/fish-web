!function ($) {
  ...
  BootstrapPaginator.prototype = {
    init: function (element, options) {
      ...
      switch (this.$element.prop("class", ""), this.$element.addClass("pagination m-0 ms-auto"), size.toLowerCase()) {
        case"large":
        case"small":
        case"mini":
      ...
      var itemContainer = $("<li class='page-item'></li>"), itemContent = $("<a class='page-link'></a>"), text = "", title = "",
