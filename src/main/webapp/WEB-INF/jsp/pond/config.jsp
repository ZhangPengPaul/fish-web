                    ...
                    <div class="col">
                        <div class="mb-1">
                            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                                <li class="breadcrumb-item"><a href="#">池塘管理</a></li>
                                <li class="breadcrumb-item"><a href="#">编辑池塘</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="#">一号塘</a></li>
                            </ol>
                        </div>
                        <h2 class="page-title">
                            一号塘
                    ...
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍池塘介绍
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
