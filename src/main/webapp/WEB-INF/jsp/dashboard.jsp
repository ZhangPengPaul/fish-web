            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="chart-temp-referrals"></div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body p-4 py-5 text-center">
                                    ...
                                    <div>
                                        <div class="avatar-list avatar-list-stacked">
                                            ...
                                            <span class="avatar avatar-sm avatar-rounded"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/002m.jpg)"></span>
                                            <span class="avatar avatar-sm avatar-rounded"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/003m.jpg)"></span>
                                            <span class="avatar avatar-sm avatar-rounded"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/000f.jpg)"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-4 py-5 text-center">
                                    ...
                                    <div>
                                        <div class="avatar-list avatar-list-stacked">
                                            ...
                                            <span class="avatar avatar-sm avatar-rounded"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/006m.jpg)"></span>
                                            <span class="avatar avatar-sm avatar-rounded"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/004f.jpg)"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="progress card-progress">
                            ...
                            <div class="divide-y-4">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/001f.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/002f.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/003f.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/007m.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/009m.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/010m.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/005f.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-auto">
                                            <span class="avatar"
                                                  style="background-image: url(<%=path%>/dist/dist/static/avatars/006f.jpg)"></span>
                                        </div>
                                        <div class="col">
                                            <div class="text-truncate">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank"
                       rel="noopener"
                       style="background-image: url(<%=path%>/dist/dist/static/sponsor-banner-homepage.svg)"
                ...
                <div class="row text-center align-items-center flex-row-reverse">
                    <div class="col-lg-auto ms-lg-auto">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item"><a href="<%=path%>/docs/index.html" class="link-secondary">Documentation</a>
                            </li>
                            <li class="list-inline-item"><a href="<%=path%>/license.html"
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts && (new ApexCharts(document.getElementById('chart-temp-referrals'), {
            chart: {
                type: "line",
                fontFamily: 'inherit',
                height: 192,
